...
All API date-time values are ISO-8601 UTC instants serialized with the `Z` offset.
This applies to persisted response timestamps such as `createdAt`, `issuedAt`,
`expiresAt`, `startsAt`, `endsAt`, `reservedAt`, and `canceledAt`, and to
...
```json
{
  "memberId": 1,
  "passProductId": 1,
  "expiresAt": "2026-08-01T14:59:59Z"
}
```
...
```json
{
  ...
  "memberPassId": 1,
  "status": "CONFIRMED",
  "reservedAt": "2026-05-01T01:30:00Z",
  "canceledAt": null,
  "cancelReason": null,
  "classSession": {
    "id": 1,
