...
| --- | --- | --- | --- |
| M0 | Project Setup | 개발 기반 구축 | Spring Boot 프로젝트, DB, Docker, 공통 설정 |
...
| M2. Member | Planned | 회원 상태와 예약 가능성 검증 필요 |
| M3. Pass | Planned | 횟수권 차감/복구 모델 필요 |
